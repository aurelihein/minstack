...
struct _MinstackList {
	struct _MinstackList *next;
	struct _MinstackList *prev;
	void *data;
};

typedef struct _MinstackList MinstackList;

char **minstack_str_split_tools (char *s, const char *ct,int *nb_element);

MinstackList *minstack_create_message_list(void);
